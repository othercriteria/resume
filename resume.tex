...
\noindent Relative to an engineer with the typical software engineer
and data scientist competencies sketched out above:

\begin{itemize*}
\item I'm constructively skeptical of data, design guarantees, and
  monitoring; these add value iff they track reality.
\item I'm unsentimental about using dumb methods over theoretically
  optimal ones or those I've built myself.
\item I look to the non-technical contexts of product, growth, and
  markets to frame technical choices. I read The Diff.
\end{itemize*}
