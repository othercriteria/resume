...
\begin{itemize*}
\item Enthusiastic: Python, R, C, Haskell, SQL. Grudging: C++, JS, Ruby, Matlab,
  Java, Scala. Curious: Go, Rust.
\item Statistics, numerics, and
  visualization libraries: scikit-learn, Pandas, TensorFlow, Stan,
  PyMC3, D3, FFIs, etc.
\item Familiarity with software engineering stack (UNIX, git/svn,
  make, etc.), scientific computation stack (MPI, reproducible
  research, \LaTeX, etc.), front-end technologies (JSX, client-server,
  HTML, CSS, XHR, etc.), and cloud deployment stack (Docker, AWS
  EC2/S3/Lambda, Heroku, etc.).
\end{itemize*}
