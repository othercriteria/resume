...
\leftandright{University of Minnesota, Dept.\ of Ecology and
  Evolutionary Biology}{June -- August 2003, 2004} \\
...
\item Seminars in Graphical Models and in Bayesian Nonparameterics.
\item Several courses in Computational Biology, covering use of
  ...
  learn structural features from messy, incomplete, and/or inconsistent data.
\end{itemize*}

\vspace{1.0em}

\ressection{Programming and technical comfort}

\begin{itemize*}
\item Enthusiastic: Python, R, C, SQL. Grudging: JavaScript, Matlab.
...
\item Familiarity with software engineering tooling (git, build
  ...
  Hakyll, etc.), and cloud deployment (Docker, AWS, etc.).
\end{itemize*}
